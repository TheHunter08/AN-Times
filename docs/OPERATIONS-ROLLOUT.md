...
- Versión transitoria actual: Times INC `4.6.0`, publicada en `https://times-inc.vercel.app`. Esta versión identifica y muestra en la propia app la migración completa de cuentas, documentos, datos y controles de seguridad; el modo continúa siendo transitorio hasta superar los requisitos del corte Auth/RLS.
