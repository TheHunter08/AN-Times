            ...
            <div style={{ width:'100%', display:'flex', flexDirection:'column', gap:12 }}>
              ...
              <div className="login-field-group">
                ...
                <button onClick={() => setPassVisible(v => !v)}
                  style={{ position:'absolute', right:12, background:'none', border:'none', color:'var(--text3)', cursor:'pointer', fontSize:18, padding:4, lineHeight:1 }}>
                  {passVisible ? '🙈' : '👁️'}
                </button>
              </div>

              {err && <div style={{ color:'var(--red)', fontSize:12, fontWeight:500, textAlign:'center' }}>{err}</div>}
              ...
              <button onClick={doGoogleLogin} disabled={loading}
                style={{ display:'flex', alignItems:'center', justifyContent:'center', gap:10, width:'100%', padding:'12px 16px', background:'var(--bg-500)', border:'1px solid var(--border2)', borderRadius:'var(--r-sm)', color:'var(--text)', fontSize:13, fontWeight:600, cursor:'pointer' }}>
              ...
              <button onClick={() => { setMode('forgot'); setForgotEmail(email); setErr(''); setForgotSent(false) }}
                style={{ background:'none', border:'none', color:'var(--primary-light)', fontSize:12, cursor:'pointer', fontWeight:600, textAlign:'center', width:'100%', marginTop:4 }}>
